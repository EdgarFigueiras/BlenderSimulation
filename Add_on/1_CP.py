        ...
        try:
            ...
            for cnt in range(0,int(line)):
                ...
                for cont in range(particles_number):
                    x_pos, amplX = calculate_position(array_with_all_data['arr_0'],array_with_all_data['arr_1'],funcInterX)
                    y_pos, amplY = calculate_position(array_with_all_data['arr_2'],array_with_all_data['arr_3'],funcInterY)
                    z_pos, amplZ = calculate_position(array_with_all_data['arr_4'],array_with_all_data['arr_5'],funcInterZ)
